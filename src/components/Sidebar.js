...
const Sidebar = () => {
 ...
 // Determine the background color and text color based on the mode
 const backgroundColor = mode === "dark" ? "#343a40" : "#efecec";
      ...
      >
        {!localStorage.getItem("token") ? (
          ...
          <>
            ...
            <button onClick={handleLogout} className="btn btn-outline-danger my-1">
              LogOut
            </button>
          </>
        )}
